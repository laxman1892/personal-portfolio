    ...
    <div className="container">
      ...
      <div className={`md:hidden bg-white flex flex-col items-center absolute top-14 right-0 gap-1 overflow-x-hidden text-center mt-2 mr-1 transition-all duration-[400ms] ease-in ${isOpen ? 'w-2/5' : 'w-0'}`}>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="w-full p-3 hover:bg-red-500"
        >
          Resume
        </a>
        <span className="w-full h-[1px] bg-black"></span>
      ...
      <h1 className="leading-[1] mt-10 md:mt-0">HI, MY NAME IS</h1>
      <h1 className="text-6xl md:text-8xl font-bold leading-[1]">LAXMAN RIJAL</h1>
      <h1 className="text-2xl md:text-5xl leading-[1.2] font-bold mx-6 md:mx-0">I BUILD THINGS FOR THE WEB.</h1>
      <h1 className="leading-[1.2] mt-6 mx-6 md:mx-0">I&apos;m a full stack developer specializing in building and designing beautiful web experiences.</h1>
    </div>
    <About />
    <Projects />
    <Contact />
